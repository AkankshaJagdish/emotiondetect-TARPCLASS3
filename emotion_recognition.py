...
class EmotionRecognizer:
    ...
    def __init__(self, model=None, **kwargs):
        ...
        """
        # emotions
        self.emotions = kwargs.get("emotions", ["neutral", "calm", "happy", "sad", "angry", "fear", "disgust", "ps" , "boredom"])
        ...
        # datasets
        self.tess_ravdess = kwargs.get("tess_ravdess", False)
    ...
    def determine_best_model(self):
        ...
        for estimator, params, cv_score in estimators:
            ...
            detector = EmotionRecognizer(estimator, emotions=self.emotions, tess_ravdess=self.tess_ravdess,
                                        ...
                                        features=self.features, balance=False, override_csv=False)
            # data already loaded
...
def plot_histograms(classifiers=True, beta=0.5, n_classes=3, verbose=1):
    ...
    for estimator, params, cv_score in estimators:
        ...
        for i in range(3):
            ...
            detector = EmotionRecognizer(estimator, verbose=0, balance=False)
            # load the data
            detector.load_data()
            if i == 0:
...
def visualize(results, n_classes):
    ...
    pl.legend()
    # Aesthetics
    pl.suptitle("Performance Metrics for Chosen Models", fontsize = 16, y = 1.10)
    pl.tight_layout()
    pl.show()